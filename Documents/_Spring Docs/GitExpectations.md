...
Each user story should be implemented in a dedicated branch created from the latest version of dev. Subtasks should be tracked through commits within the same user story branches. Merging into the dev branch requires at least one team member to review and approve the pull request.
